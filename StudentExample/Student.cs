...
class Student
{
	...
	string studentname;
	int englishmarks, generalmarks, socialmarks, environmentmarks, totalmarks;
	...
	{
		totalmarks = englishmarks + generalmarks + socialmarks + environmentmarks;

		return string.Format(" Id of an Student\t\t: {0}\n Name of a student is\t\t: {1}\n Marks in English\t\t: {2}\n Marks in General Studies\t: {3}\n Marks in Social Studies\t: {4}\n Marks in Environmental Studies\t: {5}\n Total Marks of a Student\t: {6}", studentId, studentname, englishmarks, generalmarks, socialmarks, environmentmarks, totalmarks);
	}
}
class MainClass
{
	...
	static int englishmarks, generalstudies, socialmarks, environmentalstudies;
	...
	static void Switch(int number)
	{
		switch (option)
		{
			case 1:
				AddStudent();
				studentarr[counter++] = new Student(studentname, englishmarks, generalstudies, socialmarks, environmentalstudies);
				break;
			case 2:
