...
using ShopApiNew.Data;
using ShopApiNew.Models;

namespace ShopApiNew.Controllers
{
    [Route("api")]
    [ApiController]
    public class AuthenticationController : ControllerBase
    {
        private readonly ShopApiNewContext _context;

        public AuthenticationController(ShopApiNewContext context)
        {
            _context = context;
        }        
